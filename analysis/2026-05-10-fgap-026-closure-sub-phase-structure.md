...
| **6** | 6.1 /project → /context subcommand rename • 6.2 project-* → context-* tool rename • 6.3 context-init • 6.4 context-install • 6.5 context-migrate | 6.1/6.2 serialize per index.ts; 6.3/6.4/6.5 parallel-authorable |
