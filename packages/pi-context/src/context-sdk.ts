 ...
 * today's `project:FGAP-153` (the `project` alias is not registered until the
 * planned legacy-substrate registration migration runs)
 * → `unregistered`. The real 30 are therefore `unregistered` until that
 * migration runs and flip to
