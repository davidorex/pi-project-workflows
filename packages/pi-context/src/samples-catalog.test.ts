 ...
 *   - structural completeness (16 kinds; 31 relation_types; registries present)
...
describe("samplesCatalog", () => {
	...
	it("exposes the full top-level registries (31 relation_types; lenses/invariants/layers/status_buckets defined)", () => {
		const c = samplesCatalog();
		assert.strictEqual(c.relationTypes.length, 31);
