 ...
 *   - structural completeness (15 kinds; 27 relation_types; registries present)
...
describe("samplesCatalog", () => {
	...
	it("exposes the full top-level registries (27 relation_types; lenses/invariants/layers/status_buckets defined)", () => {
		const c = samplesCatalog();
		assert.strictEqual(c.relationTypes.length, 27);
