 ...
 * command-allowlist composite KIND library function (part of the composite-tool
 * infrastructure: framework-implemented KINDs, config-declared per-project instances).
 *
